#if UNITY_EDITOR
namespace Lasm.Continuum.OdinSerializer.Utilities.Editor
{
    using Lasm.Continuum.OdinSerializer.Editor;
    using UnityEditor;
    using UnityEditor.Build;
    using System.IO;
    using System;
    using System.Collections.Generic;
    using Lasm.Continuum.OdinSerializer.Utilities;
    ...
    public static class OdinBuildAutomation
    {
        ...
        static OdinBuildAutomation()
        {
            ...
            EditorAssemblyPath    = odinSerializerDir + "/EditorOnly/Lasm.Continuum.OdinSerializer.dll";
            AOTAssemblyPath       = odinSerializerDir + "/AOT/Lasm.Continuum.OdinSerializer.dll";
            JITAssemblyPath       = odinSerializerDir + "/JIT/Lasm.Continuum.OdinSerializer.dll";
